<template>
  <Layout :pageTitle="__('Create Lesson')">
    <PageHeader :breadcrumb_title="__('Create Lesson')" />
    <div class="container-fluid">
      <form class="form theme-form" @submit.prevent="form.post(route('teacher.lessons.store'))">
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="f-w-300">
                  <i class="fa fa-book"></i>{{ __('Create Lesson') }}
                </h5>
              </div>
              <div class="card-body">
                <div class="row">
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-9">
                        <input v-model="form.youtube_link" class="form-control form-control-sm"
                          :class="[errors.youtube_link ? 'is-invalid' : '']" type="text" :placeholder="__('Youtube Link')" />
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-footer p-5">
                ...
                <Link :href="route('teacher.lessons.index')" class="btn btn-sm btn-light float-right">{{ __('Cancel') }}</Link>
              </div>
            </div>
          </div>
        </div>
