<template>
  <Layout :pageTitle="__('Profile')" :avatar="avatar">
    <PageHeader :breadcrumb_title="__('Profile')" />
    <div class="container-fluid">
      <div v-if="$page.props.flash.success" class="alert alert-success" role="alert">
        <p>{{ $page.props.flash.success }}</p>
      </div>
      <form class="form theme-form" @submit.prevent="form.post(route('teacher.profile.store'))">
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                ...
                <div class="row mt-5">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input v-model="form.email" class="form-control" :placeholder="__('Email')"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input style="
                        ...
                        :class="[errors.password ? 'is-invalid' : '']" type="password" :placeholder="__('Password')" />
                ...
                <div class="form-footer">
                  <button type="submit" class="btn btn-primary mt-3 btn-sm pull-right">
                    {{ __('Save') }}
                  </button>
                </div>
              </div>
