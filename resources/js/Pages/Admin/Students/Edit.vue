<template>
  <Layout :pageTitle="'Edit Student'">
    <PageHeader :breadcrumb_title="'Edit Student'" />
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3 row">
                      <label class="col-sm-3 col-form-label" for="password_confirmation">{{ __('Confirm Password')
                      }}</label>
                      <div class="col-sm-9">
              ...
              <div class="card-footer p-5">
                ...
                <Link :href="route('admin.students.index')" class="btn btn-sm btn-light pull-right">{{ __('Cancel') }}
                </Link>
              </div>
            </div>
          </div>
...
export default {
  ...
  setup(props) {
    ...
    const form = useForm({
      ...
      study_group_id: props.student.study_group_id,
      name: props.student.name,
      email: props.student.email,
      password: "",
      password_confirmation: "",
      NISN_number: props.student.NISN_number,
      gender: props.student.gender,
      religion: props.student.religion,
      place_of_birth: props.student.place_of_birth,
      date_of_birth: props.student.date_of_birth,
      road: props.student.road,
      village: props.student.village,
      subdistrict: props.student.subdistrict,
    ...
    function submit() {
      Inertia.post(route('admin.students.update', this.form.id), {
        _method: 'put',
        form: this.form,
      })
    }
