  ...
  <div class="page-sidebar">
    ...
    <div class="sidebar custom-scrollbar">
      <ul class="sidebar-menu">
        <li :class="{ current: activeRoute('admin.logo.index') }">
          <Link :href="route('admin.logo.update')" class="sidebar-header">
        ...
        <li :class="{ current: activeRoute('admin.profile') }">
          <Link :href="route('admin.profile')" class="sidebar-header">
        ...
        <li :class="{ current: activeRoute('admin.dashboard') }">
          <Link :href="route('admin.dashboard')" class="sidebar-header">
        ...
        <li :class="{ current: activeRoute('admin.teachers.index') }">
          <Link :href="route('admin.teachers.index')" class="sidebar-header">
          <svg fill="#fff" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 489.38 489.38"
        ...
        <li :class="{ current: activeRoute('admin.students.index') }">
          <Link :href="route('admin.students.index')" class="sidebar-header">
        ...
        <li :class="{ current: activeRoute('admin.study-groups.index') }">
          <Link :href="route('admin.study-groups.index')" class="sidebar-header">
          <svg fill="#fff" width="800px" height="800px" viewBox="0 0 36 36" version="1.1"
            ...
            <path class="clr-i-solid clr-i-solid-path-3"
              d="M11.1,14.19c.11,0,.2,0,.31,0a6.45,6.45,0,0,1,3.11-6.29,4.09,4.09,0,1,0-3.42,6.33Z"></path>
          ...
          <span>{{ __("Study Groups") }}</span>
          </Link>
        </li>
        <li :class="{ current: activeRoute('admin.school-classes.index') }">
          <Link :href="route('admin.school-classes.index')" class="sidebar-header">
          <svg fill="#fff" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 488 488"
            ...
            <g transform="translate(0 -540.36)">
              <g>
                <g>
                  ...
                  <path
                    d="M264.6,702.41c5.5,0,10-4.5,10-10v-9.9c5.5,0,9.9-4.5,9.9-10s-4.4-9.9-9.9-10v-9.9c0-5.5-4.5-10-10-10s-10,4.5-10,10v9.9
        				h-10.5v-30.5c0-5.5-4.5-10-10-10s-10,4.5-10,10v40.5c0,5.5,4.5,10,10,10h20.5v9.9C254.6,697.91,259.1,702.41,264.6,702.41z" />
                  <path
                    d="M40.4,784.11h254.5v10.6c0,5.5,4.5,10,10,10h122c5.5,0,10-4.5,10-10v-81c0-5.4-4.4-9.9-10-9.9v0c-5.5,0-10,4.5-10,10v71
                  ...
                  <path
                    d="M30.5,886.41c0,22.4,18.2,40.6,40.5,40.6s40.5-18.2,40.5-40.6c0-22.4-18.2-40.6-40.5-40.6S30.5,864.01,30.5,886.41z
                  ...
                  <path
                    d="M376.5,886.41c0,22.4,18.2,40.6,40.5,40.6s40.5-18.2,40.5-40.6c0-22.4-18.2-40.6-40.5-40.6S376.5,864.01,376.5,886.41z
                  ...
                  <path
                    d="M203.5,886.41c0,22.4,18.2,40.6,40.5,40.6s40.5-18.2,40.5-40.6c0-22.4-18.2-40.6-40.5-40.6S203.5,864.01,203.5,886.41z
        ...
        <li :class="{ current: activeRoute('admin.books.index') }">
          <Link :href="route('admin.books.index')" class="sidebar-header">
          <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M2 6C2 6 3.5 4 7 4C10.5 4 12 6 12 6V20C12 20 10.5 19 7 19C3.5 19 2 20 2 20V6Z" stroke="#fff"
              stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M12 6C12 6 13.5 4 17 4C20.5 4 22 6 22 6V20C22 20 20.5 19 17 19C13.5 19 12 20 12 20V6Z" stroke="#fff"
              stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
          <span>{{ __("Books") }}</span>
          </Link>
        </li>
        <li :class="{ current: activeRoute('admin.subjects.index') }">
          <Link :href="route('admin.subjects.index')" class="sidebar-header">
          <svg fill="#fff" width="800px" height="800px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M13,16H3a1,1,0,0,0,0,2H13a1,1,0,0,0,0-2ZM3,8H21a1,1,0,0,0,0-2H3A1,1,0,0,0,3,8Zm18,3H3a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2Z" />
          </svg>
