<template>
  <Layout pageTitle="Create Teacher">
    <PageHeader :breadcrumb_title="__('Create Teacher')" />
    <div class="container-fluid">
      <form class="form theme-form" @submit.prevent="form.post(route('admin.teachers.store'))">
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5>{{ __('Create Teacher') }}</h5>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3 row">
                      <label class="col-sm-3 col-form-label">{{ __('Education') }}</label>
                      <div class="col-sm-9">
                        <input v-model="form.education" class="form-control form-control-sm"
                          :class="[errors.education ? 'is-invalid' : '']" type="text" />
                        <div class="txt-danger">{{ errors.education }}</div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-9">
                        <select v-model="form.gender" class="form-control form-control-sm" id="gender">
                          <option>Male</option>
                  ...
                  <div class="col-md-6">
                    <div class="mb-3 row">
                      <label class="col-sm-3 col-form-label">{{ __('Appointment Decree') }}</label>
                      <div class="col-sm-9">
                        <input v-model="form.appointment_decree" class="form-control form-control-sm" :class="[
                          errors.appointment_decree ? 'is-invalid' : '',
                        ]" type="text" />
                        <div class="txt-danger">
                          {{ errors.appointment_decree }}
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3 row">
                      <label class="col-sm-3 col-form-label">{{ __('TMT: Date') }}</label>
                      <div class="col-sm-9">
                        <Datepicker v-model="form.date" :enable-time-picker="false" auto-apply
                          :highlight-week-days="[0, 6]"></Datepicker>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
              ...
              <div class="card-footer p-5">
                ...
                <Link :href="route('admin.teachers.index')" class="btn btn-sm btn-light pull-right">{{ __('Cancel') }}</Link>
              </div>
            </div>
          </div>
        </div>
