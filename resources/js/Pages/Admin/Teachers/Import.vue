<template>
  <Layout :pageTitle="__('Import Teachers')">
    <PageHeader :breadcrumb_title="__('Import Teachers')" />
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-sm-12">
          <form class="form theme-form" @submit.prevent="form.post(route('admin.import.teachers.store'))">
            <div class="card">
              <div class="card-header">
                <h5>{{ __('Import Teachers') }}</h5>
              ...
              <div class="card-body">
                <div class="alert alert-info dark alert-dismissible fade show" role="alert"><strong>{{ __('Note') }}:</strong> {{ __('Make sure to reset file field after making changes to the file.') }}</div>
                <div class="mb-3 row">
