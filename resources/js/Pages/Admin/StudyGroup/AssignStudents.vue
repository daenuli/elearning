        ...
        <div class="container-fluid">
          ...
          >
           ...
           <form
            ...
            @submit.prevent="form.post(route('admin.study-group.assign-students.store', study_group.id))"
          >
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <span
                      >Select and add students to the study group
                      {{ study_group.name }}</span
                    >
                    <div class="card-header-right">
                      <Link :href="route('admin.study-groups.index')" class="btn btn-success">
